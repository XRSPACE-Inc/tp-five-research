...
namespace GaussianSplatting.Runtime
{
    ...
    public class GpuSorting
    {
        ...
        public void Dispatch(CommandBuffer cmd, Args args, bool debug)
        {
            Assert.IsTrue(Valid);
            ...
            // if (debug)
            // {
            //     CSDebugger.Instance.PrintNow("InitDeviceRadixSort");
            // }
            ...
            for (constants.radixShift = 0; constants.radixShift < 32; constants.radixShift += DEVICE_RADIX_SORT_BITS)
            {
                ...
                // if (debug)
                // {
                //     CSDebugger.Instance.PrintNow("Upsweep");
                // }
                ...
                // if (debug)
                // {
                //     CSDebugger.Instance.PrintNow("Scan");
                // }
                ...
                // if (debug)
                // {
                //     CSDebugger.Instance.PrintNow("Downsweep");
                // }
