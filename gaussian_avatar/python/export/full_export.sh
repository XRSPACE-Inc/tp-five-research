printf "run in root!\n"
python -m export.export_to_unity --idname myslate_11_css_iphone --checkpoint dataset/myslate_11_css_iphone/log/ckpt/chkpnt150000.pth -med -ss || { echo 'failed' ; exit 1; }
printf "======================= export export/source_dict.pth =======================\n"
python -m export.export || { echo 'failed' ; exit 1; }
