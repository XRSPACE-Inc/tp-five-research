...
if __name__ == "__main__":
    ...
    # deform model
    DeformModel = Deform_Model(args.device, 53).to(args.device)
    ...
    scene = Scene_mica(data_dir, mica_datadir, train_type=0, white_background=lpt.white_background, device=args.device, ict=True)
