...
if __name__ == "__main__":
    ...
    # deform model
    DeformModel = Deform_Model(args.device, 51, use_same_shape=True).to(args.device)
    ...
    scene = Scene_mica(data_dir, mica_datadir, train_type=1, white_background=lpt.white_background, device=args.device, mediapipe=True)
    ...
    out = cv2.VideoWriter(vid_save_path, fourcc, 25, (im_size[0] * 3, im_size[1]), True)
