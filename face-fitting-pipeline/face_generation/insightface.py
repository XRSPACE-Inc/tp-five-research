...
def _iresnet(arch, block, layers, pretrained, progress, map_location, **kwargs):
...
def iresnet34(pretrained=False, progress=True, map_location=None, **kwargs):
    return _iresnet('iresnet34', IBasicBlock, [3, 4, 6, 3], pretrained, progress, map_location,
                    **kwargs)


def iresnet50(pretrained=False, progress=True, map_location=None, **kwargs):
    return _iresnet('iresnet50', IBasicBlock, [3, 4, 14, 3], pretrained, progress, map_location,
                    **kwargs)


def iresnet100(pretrained=False, progress=True, map_location=None, **kwargs):
    return _iresnet('iresnet100', IBasicBlock, [3, 13, 30, 3], pretrained, progress, map_location,
                    **kwargs)
